    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btnAddToCart.setOnClickListener(v -> {
            ...
            if (selectedSizeId != -1) {
                ...
                Toast.makeText(DetailDrink.this, "Added to cart", Toast.LENGTH_SHORT).show();
            } else {
                Toast.makeText(DetailDrink.this, "Please select a size", Toast.LENGTH_SHORT).show();
            }
        });

        // Xử lý nút View Cart
        btnViewCart.setOnClickListener(v -> {
            Intent cartIntent = new Intent(DetailDrink.this, CartActivity.class);
            startActivity(cartIntent);
        });

        backdetail = findViewById(R.id.backdetail);
        backdetail.setOnClickListener(v -> {
            Intent backIntent = new Intent(DetailDrink.this, Home.class);
